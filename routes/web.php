...
Route::redirect('/', 'bawangmerah');
Route::get('/bawangmerah', [DashboardController::class, 'bawangmerah'])->name('bawangmerah');
Route::get('/bawangputih', [DashboardController::class, 'bawangputih'])->name('bawangputih');
Route::get('/beras', [DashboardController::class, 'beras'])->name('beras');
Route::get('/cabaimerah', [DashboardController::class, 'cabaimerah'])->name('cabaimerah');
Route::get('/cabairawit', [DashboardController::class, 'cabairawit'])->name('cabairawit');
Route::get('/ayamras', [DashboardController::class, 'ayamras'])->name('ayamras');
Route::get('/sapi', [DashboardController::class, 'sapi'])->name('sapi');
Route::get('/gula', [DashboardController::class, 'gula'])->name('gula');
Route::get('/kembung', [DashboardController::class, 'kembung'])->name('kembung');
Route::get('/jeruk', [DashboardController::class, 'jeruk'])->name('jeruk');
Route::get('/miekering', [DashboardController::class, 'miekering'])->name('miekering');
Route::get('/minyak', [DashboardController::class, 'minyak'])->name('minyak');
Route::get('/pisang', [DashboardController::class, 'pisang'])->name('pisang');
Route::get('/susububuk', [DashboardController::class, 'susububuk'])->name('susububuk');
Route::get('/susubalita', [DashboardController::class, 'susubalita'])->name('susubalita');
Route::get('/tahu', [DashboardController::class, 'tahu'])->name('tahu');
Route::get('/telur', [DashboardController::class, 'telur'])->name('telur');
Route::get('/tempe', [DashboardController::class, 'tempe'])->name('tempe');
Route::get('/tepung', [DashboardController::class, 'tepung'])->name('tepung');
Route::get('/udang', [DashboardController::class, 'udang'])->name('udang');
Route::get('/inflasiyoy', [DashboardController::class, 'inflasiyoy'])->name('inflasiyoy');
Route::get('/inflasiytd', [DashboardController::class, 'inflasiytd'])->name('inflasiytd');
Route::get('/inflasimtm', [DashboardController::class, 'inflasimtm'])->name('inflasimtm');
